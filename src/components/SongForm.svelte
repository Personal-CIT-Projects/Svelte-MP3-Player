...
<div id="songForm">
    ...
    {/if}
    <div class="mb-4">
        <label class="block text-sm font-medium leading-6 text-gray-900" for="artist">Artist</label>
        <div class="relative mt-2 rounded-md shadow-sm">
            <input type="text" required bind:value={artist} id="artist"
    ...
    <div class="mb-4">
        ...
        <div class="relative mt-2 rounded-md shadow-sm">
            <input type="text" required bind:value={title} id="title"
                   class="block w-full rounded-md border-0 py-1.5 pl-3 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                   placeholder="Let it rain!">
        </div>
    </div>
    <div class="mb-4">
        <label class="block text-sm font-medium leading-6 text-gray-900" for="file">File</label>
        <div class="relative mt-2 rounded-md shadow-sm">
            <input accept=".mp3" type="file" bind:files id="file"
                   class="block w-full rounded-md border-0 py-1.5 pl-3 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
    </div>
